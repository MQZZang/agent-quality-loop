...
| `.ai/knowledge/` | Two templates you rename and fill in, plus this package's own maintenance lessons and prompt-pattern notes — those last two stay here rather than going into your project |
